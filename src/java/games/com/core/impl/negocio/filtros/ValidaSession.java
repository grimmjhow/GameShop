 ...
 * @author Felipe
 */
/*@WebFilter(filterName = "ValidaSession", 
urlPatterns = {"/index.jsp","/SelecionarPagamento","/ConfirmaEndereco.jsp","/Pedidos.jsp","/MetodoPagamento.jsp","/DesativarConta","/DesativarConta.jsp"})*/
public class ValidaSession implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response,FilterChain chain)throws IOException, ServletException
    {
        ...
        if(cliente == null) //nao existe cliente logado?
        {
            req.getSession().setAttribute("requestUrl", req.getRequestURI().replace("Ecommerce","").replace("/", ""));
