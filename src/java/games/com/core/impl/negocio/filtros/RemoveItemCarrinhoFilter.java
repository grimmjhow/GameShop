...
public class RemoveItemCarrinhoFilter implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        {
           pedido.getItens().clear();   //limpando carrinho!
        ...
        } else
        {
            ...
            {
                ((HttpServletResponse) response).sendRedirect("Games.jsp"); //redirecionando pagina
            } else
            {
                ((HttpServletResponse) response).sendRedirect("VisualizarCarrinho.jsp"); //redirecionando pagina   
            }
        }
    }
