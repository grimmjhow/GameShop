...
import games.com.br.util.BuscaCEP;
import games.com.br.util.EnderecoJson;
 ...
 * @author Felipe
 */
/*@WebFilter(filterName = "CarregaCepFilter", urlPatterns =
{
    "/CarregaCep","/BuscaCep"
})*/
public class CarregaCepFilter implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response,FilterChain chain)throws IOException, ServletException
    {
        ...
        url.put("/Ecommerce/BuscaCep", "SalvarCliente.jsp");
        url.put("/Ecommerce/CarregaCep", "ConfirmaEndereco.jsp");
