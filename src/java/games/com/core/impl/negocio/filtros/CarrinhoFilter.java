...
{
    private Connection conn;    //atributo de conexao com o banco!
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)throws IOException, ServletException, ClassNotFoundException, SQLException
    {
        ...
        {
            conn = Conexao.getConnetion(); //pegando conexao com o banco!
            ((HttpServletRequest)request).getSession().setAttribute("conn",conn);   //conexao agora pode ser acessada de qualquer lugar!
        }  
    }
    ...
    public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain) throws IOException, ServletException
    {
        ...
        IViewHelper vh = ViewHelperFactory.create(url);
        
        vh.getEntidade(request, response);  //pegando request
        
        vh.setView(null, request, response);    //setando view do usuario!
    }
