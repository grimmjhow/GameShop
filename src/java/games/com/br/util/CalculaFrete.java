...
public class CalculaFrete
{
    ...
    public Frete getInfoFrete(String CEP, String tipoServico) throws MalformedURLException, IOException
    {
        ...
        urlPath.append("sCepOrigem=08710680&");
        ...
        HttpURLConnection httpConnection = (HttpURLConnection) url.openConnection();    //enviando requisicao para o web service
        
        InputStream input = httpConnection.getInputStream();    //pegando resultado da requisicao
