...
import games.com.core.impl.negocio.ValidaLogin;
...
public class LoginFiltro implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException
    {
        ...
        if (login == null)
        {
            ...
            {
                ((HttpServletResponse) response).sendRedirect("/Ecommerce/root/dashboard.jsp");
            } else
            {
                if (lastRequest == null || lastRequest.equals(""))
                {
                    ((HttpServletResponse) response).sendRedirect("Games.jsp");
                } else
                {
