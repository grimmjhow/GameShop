...
public class CalculaFreteFilter implements Filter
{
    ...
    public void doFilter(ServletRequest request, ServletResponse response,FilterChain chain)throws ServletException, IOException
    {
        ...
        CalculaFrete calcula = new CalculaFrete();//objeto para calcular um valor de frete
        ...
        {
            req.getRequestDispatcher("VisualizarCarrinho.jsp").forward(request, response);  //mandando a requisicao de volta
        }
    }
